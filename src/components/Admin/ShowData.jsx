  ...
  const file = (rowsPerPage > 0
    ...
    return (
      <TableRow key={value.id}>
        <TableCell>
          <img
            src={props.getIcon(value.isFile, value.ext)}
            alt={value.ext}
            width="24px"
          />
        </TableCell>
        ...
        <TableCell>
          {value.name.length > 30 ? value.name.substring(0, 27) : value.name}
        </TableCell>
        ...
        <TableCell align="right">
          <a
            className={props.useTheme ? classes.a : ''}
            href={`#file${value.dependency}`}
          >
            {value.dependency}
          </a>
        </TableCell>
      ...
      >
        <TableHead>
          <TableRow>
            ...
            <TableCell aria-label="delete" align="right">
              Eliminar
            </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>{file}</TableBody>
      </Table>
    </TableContainer>
  );
